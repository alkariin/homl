...
| [homl-web/docs/auth-flows.md](homl-web/docs/auth-flows.md) | Login, refresh with PIN/fingerprint, the client session offline, password reset, logout, account deletion |
